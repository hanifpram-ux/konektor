...
class Konektor_Snack {
    ...
    public static function get_script( $campaign, $event_type ) {
        ...
        $pixel_id = trim( $cfg['pixel_id'] ?? '' );
        if ( ! $pixel_id ) return '';

        $default_map = [
            'page_load'   => 'page',
            'form_submit' => 'SubmitForm',
            'thanks_page' => 'CompletePayment',
        ];
        $cfg_key_map = [
