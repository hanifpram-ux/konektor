...
class Konektor_API {
    ...
    public static function handle_form_submit() {
        ...
        $lead_data = [
            ...
            '_vid'           => sanitize_text_field( $_POST['_vid'] ?? '' ),
        ];
    ...
    public static function handle_wa_click() {
        ...
        // Server-side CAPI untuk WA Link click (form_submit equivalent)
        $lead_data = [
            'source_url' => esc_url_raw( $_POST['source_url'] ?? ( $_SERVER['HTTP_REFERER'] ?? home_url() ) ),
