        ...
        if ( ! $is_double ) {
            ...
            $wpdb->insert( $wpdb->prefix . 'konektor_api_logs', [
                ...
                'payload'     => wp_json_encode( [
                    ...
                    'form_submit_event' => ! empty( $meta_cfg['form_submit_event'] ) ? $meta_cfg['form_submit_event'] : '(kosong)',
                    'thanks_page_event' => ! empty( $meta_cfg['thanks_page_event'] ) ? $meta_cfg['thanks_page_event'] : '(kosong)',
