...
function knk_form_preview($cfg, $campaign) {
  ...
  $px_badges = [];
  if (!empty($px_cfg['meta']['pixel_id']))     $px_badges[] = '<span style="display:inline-flex;align-items:center;gap:4px;font-size:10px;font-weight:600;background:#1877f2;color:#fff;padding:3px 8px;border-radius:99px;"><span style="width:6px;height:6px;border-radius:50%;background:#fff;"></span>Meta</span>';
  if (!empty($px_cfg['tiktok']['pixel_id']))   $px_badges[] = '<span style="display:inline-flex;align-items:center;gap:4px;font-size:10px;font-weight:600;background:#010101;color:#fff;padding:3px 8px;border-radius:99px;"><span style="width:6px;height:6px;border-radius:50%;background:#fff;"></span>TikTok</span>';
  if (!empty($px_cfg['google']['conversion_id']) || !empty($px_cfg['google']['gtm_id']) || !empty($px_cfg['google']['ga4_id']))
    $px_badges[] = '<span style="display:inline-flex;align-items:center;gap:4px;font-size:10px;font-weight:600;background:#4285f4;color:#fff;padding:3px 8px;border-radius:99px;"><span style="width:6px;height:6px;border-radius:50%;background:#fff;"></span>Google</span>';
  if (!empty($px_cfg['snack']['pixel_id']))    $px_badges[] = '<span style="display:inline-flex;align-items:center;gap:4px;font-size:10px;font-weight:600;background:#e4372c;color:#fff;padding:3px 8px;border-radius:99px;"><span style="width:6px;height:6px;border-radius:50%;background:#fff;"></span>Snack</span>';
