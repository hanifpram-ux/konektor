...
$radius_default = ( $tpl === 'classic_flat' ) ? '3px' : '12px';
$radius  = ! empty( $cs['border_radius'] )  ? $cs['border_radius']  : $radius_default;
...
<?php if ( $tpl === 'classic_flat' ) : ?>
  .knk-alert-error { border-radius: 4px; background: #ffebee; color: #c62828; border: 1px solid #ef5350; text-align: center; }
