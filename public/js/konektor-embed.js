...
(function () {
    ...
    function renderForm(el, actionUrl, cfg, campType) {
        ...
        // ── Same 9-scheme system as standalone form.php ──────────────────
        var schemes = {
        ...
        var radius  = cs.border_radius  || '12px';
        ...
        style.textContent = [
            ...
            '#' + uid + ' .knk-embed-label{display:block;font-size:13px;font-weight:600;margin-bottom:5px;color:' + text + ';}',
            '#' + uid + ' .knk-embed-req{color:#ef4444;margin-left:2px;}',
            '#' + uid + ' .knk-embed-input,#' + uid + ' .knk-embed-textarea,#' + uid + ' .knk-embed-select{width:100%;padding:10px 12px;font-size:' + fsize + ';border:1.5px solid ' + border + ';border-radius:8px;background:' + inputBg + ';color:' + text + ';outline:none;font-family:inherit;transition:border-color .15s;}',
            '#' + uid + ' .knk-embed-input:focus,#' + uid + ' .knk-embed-textarea:focus,#' + uid + ' .knk-embed-select:focus{border-color:' + accent + ';}',
            '#' + uid + ' .knk-embed-textarea{resize:vertical;min-height:80px;}',
            ...
            '#' + uid + ' .knk-embed-btn{display:block;width:100%;padding:' + bpy + ' 20px;font-size:' + bfsize + ';font-weight:700;background:' + accent + ';color:' + btnText + ';border:none;border-radius:8px;cursor:pointer;font-family:inherit;margin-top:6px;transition:opacity .15s,transform .1s;}',
            '#' + uid + ' .knk-embed-btn:hover{opacity:.88;transform:translateY(-1px);}',
            '#' + uid + ' .knk-embed-alert{padding:10px 14px;border-radius:8px;margin-bottom:14px;font-size:13px;font-weight:600;}',
            '#' + uid + ' .knk-embed-alert-error{background:#fee2e2;color:#b91c1c;}',
