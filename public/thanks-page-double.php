...
body{min-height:100vh;display:flex;align-items:center;justify-content:center;background:#fefce8;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;padding:20px}
...
.knk-title{font-size:19px;font-weight:800;color:#111827;margin-bottom:12px;line-height:1.3}
.knk-notice{font-size:14px;color:#92400e;background:#fef3c7;border:1px solid #fde68a;border-radius:8px;padding:12px 16px;margin-bottom:22px;line-height:1.6}
...
<div class="knk-card">
  ...
  <p class="knk-notice"><?php echo esc_html( $double_message ); ?></p>
